...
module count_binary_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> button_pio_s1_agent:cp_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> seven_seg_pio_s1_agent:cp_valid
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> seven_seg_pio_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // seven_seg_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> seven_seg_pio_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> seven_seg_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> seven_seg_pio_s1_agent:cp_endofpacket
	...
	wire   [85:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [103:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [103:0] led_pio_s1_agent_rp_data;                                                           // led_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] button_pio_s1_agent_rp_data;                                                        // button_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire          seven_seg_pio_s1_agent_rp_valid;                                                    // seven_seg_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [103:0] seven_seg_pio_s1_agent_rp_data;                                                     // seven_seg_pio_s1_agent:rp_data -> router_008:sink_data
	wire          seven_seg_pio_s1_agent_rp_ready;                                                    // router_008:sink_ready -> seven_seg_pio_s1_agent:rp_ready
	wire          seven_seg_pio_s1_agent_rp_startofpacket;                                            // seven_seg_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          seven_seg_pio_s1_agent_rp_endofpacket;                                              // seven_seg_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire    [6:0] new_sdram_controller_0_s1_burst_adapter_source0_channel;                            // new_sdram_controller_0_s1_burst_adapter:source0_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire   [85:0] router_004_src_data;                                                                // router_004:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                               // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [6:0] router_004_src_channel;                                                             // router_004:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_valid;                              // new_sdram_controller_0_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [103:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_ready;                              // rsp_demux_002:sink_ready -> new_sdram_controller_0_s1_rsp_width_adapter:out_ready
	wire    [6:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_startofpacket;                      // new_sdram_controller_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_endofpacket;                        // new_sdram_controller_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> new_sdram_controller_0_s1_cmd_width_adapter:in_valid
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                              // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> new_sdram_controller_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> new_sdram_controller_0_s1_cmd_width_adapter:in_endofpacket
	...
	wire    [6:0] new_sdram_controller_0_s1_cmd_width_adapter_src_channel;                            // new_sdram_controller_0_s1_cmd_width_adapter:out_channel -> new_sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	wire   [17:0] new_sdram_controller_0_s1_agent_rdata_fifo_out_data;                                // new_sdram_controller_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	...
	wire   [17:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> new_sdram_controller_0_s1_agent:rdata_fifo_sink_data
	...
	wire          seven_seg_pio_s1_agent_rdata_fifo_src_valid;                                        // seven_seg_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] seven_seg_pio_s1_agent_rdata_fifo_src_data;                                         // seven_seg_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          seven_seg_pio_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_006:in_0_ready -> seven_seg_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> seven_seg_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> seven_seg_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // seven_seg_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> seven_seg_pio_s1_agent:rdata_fifo_sink_error
	...
	count_binary_mm_interconnect_0_router_003 router_003 (
	...
	count_binary_mm_interconnect_0_router_002 router_005 (
	...
	count_binary_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	count_binary_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	count_binary_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	count_binary_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	count_binary_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	count_binary_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
